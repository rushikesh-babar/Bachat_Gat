...
const SelectMonthYear = () => {
  ...
  const handleGo = () => {
    if (month && year) {
      navigate(`/add-collection-list/${month}/${year}`);
    } else {
    ...
    <div className="min-vh-100 d-flex flex-column justify-content-center align-items-center bg-light">
      ...
      >
        <div className="text-center mb-4">
          <h3 className="fw-bold text-primary">Select Month & Year</h3>
          <p className="text-muted">Choose the collection month and year to proceed</p>
        </div>
